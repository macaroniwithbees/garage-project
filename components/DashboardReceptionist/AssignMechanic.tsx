...
export default function AssignMechanic({
	...
	return createPortal(
		...
		>
			...
			>
				<h3 style={{ fontSize: "2.25rem", fontWeight: 700, color: "#0f172a" }}>Monteur Toewijzen</h3>
				<p style={{ marginTop: "12px", fontSize: "1.5rem", color: "#475569" }}>{appointment.voertuig}</p>

				<label htmlFor="monteur" style={{ display: "block", marginTop: "24px", fontSize: "1.5rem", fontWeight: 600, color: "#0f172a" }}>
					Selecteer monteur
				</label>
				<select
					id="monteur"
